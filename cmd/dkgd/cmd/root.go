...
import (
	...
	"github.com/fairblock/dkg-core/app/params"
	"github.com/fairblock/dkg-core/cmd/dkgd/cmd/utils"
	"github.com/fairblock/dkg-core/cmd/dkgd/cmd/vald"
)

// NewRootCmd creates a new root command for dkgd. It is called once in the
// main function.
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	rootCmd := &cobra.Command{
		...
		PersistentPreRunE: func(cmd *cobra.Command, _ []string) error {
			...
			DKGAppTemplate, DKGAppConfig := initAppConfig()
			err := server.InterceptConfigsPreRunHandler(cmd, DKGAppTemplate, DKGAppConfig)
			if err != nil {
				return err
			}
...
func initAppConfig() (string, interface{}) {
	...
	dkgAppConfig := DKGAppConfig{
		Config: *srvCfg,
	}

	customAppTemplate := serverconfig.DefaultConfigTemplate

	return customAppTemplate, dkgAppConfig
}
...
func export(encCfg params.EncodingConfig) servertypes.AppExporter {
	return func(logger log.Logger, db dbm.DB, traceStore io.Writer, height int64, forZeroHeight bool, jailAllowedAddrs []string,
		...
		aApp := app.NewDKGApp(logger, db, traceStore, height == -1, map[int64]bool{}, homePath,
