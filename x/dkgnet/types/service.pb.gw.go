...
// source: dkgnet/v1beta1/service.proto
...
var (
	pattern_MsgService_Link_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"dkg", "dkgnet", "link", "recipient_chain"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MsgService_ConfirmDeposit_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"dkg", "dkgnet", "confirm-deposit"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MsgService_ExecutePendingTransfers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"dkg", "dkgnet", "execute-pending-transfers"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MsgService_RegisterIBCPath_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"dkg", "dkgnet", "register-ibc-path"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MsgService_AddCosmosBasedChain_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"dkg", "dkgnet", "add-cosmos-based-chain"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MsgService_RegisterAsset_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"dkg", "dkgnet", "register-asset"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MsgService_RefundMsg_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"dkg", "dkgnet", "refund-message"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MsgService_RouteIBCTransfers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"dkg", "dkgnet", "route-ibc-transfers"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MsgService_RegisterFeeCollector_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"dkg", "dkgnet", "register-fee-collector"}, "", runtime.AssumeColonVerbOpt(true)))
)
